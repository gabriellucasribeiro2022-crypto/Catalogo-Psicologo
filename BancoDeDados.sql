...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20/06/2026 às 17:16
...
--
-- Banco de dados: `catalogo_psicologo`
--
...
(1, 'Psicoterapia Individual', 'Atendimento focado nas demandas individuais do paciente, auxiliando na compreensão de emoções e comportamentos.', 50, 150.00),
(2, 'Terapia de Casal', 'Espaço para mediação de conflitos e melhoria da comunicação entre parceiros.', 60, 220.00),
(3, 'Orientação Vocacional', 'Processo estruturado para ajudar jovens e adultos na escolha de suas carreiras e profissões.', 50, 180.00);
...
INSERT INTO `servico_categoria` (`servico_id`, `categoria_id`) VALUES
(1, 1),
(1, 2),
(2, 3),
(3, 2);
...
ALTER TABLE `servico_categoria`
  ADD PRIMARY KEY (`servico_id`,`categoria_id`),
